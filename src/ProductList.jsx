    ...
    return (
        <div>
            ...
            <div style={styleObjUl}>
             ...
             <p className='cart_quantity_count'>{cartItems.length > 0? cartItems.length: ''}</p></h1></a></div>
            </div>
        </div>
        {!showCart? (
                ...
                <div className="product-list">
                    ...
                    <div className="product-card" key={plantIndex}>
                        ...
                        <button  className={`product-button ${
                                alreadyInCart(plant.name) ? 'added-to-cart' : ''
                                }`}
                        disabled= {alreadyInCart(plant.name)} onClick={() => handleAddToCart(plant)}>
                        {alreadyInCart(plant.name) ? 'Already in Cart' : 'Add to Cart'}</button>
                    </div>
                    ))}
                </div>
            </div>
